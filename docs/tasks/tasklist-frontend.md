...
Этапы **4** (административный веб) и **5** (клиентский веб) — **✅ done** в [plan.md](../plan.md); итерации **iter-fe-00 … iter-fe-09** ниже. Пересечения с этапами **3** (LLM) и **6** (delivery) см. таблицу «Связь с plan.md».
